    ...
    extend: {
      colors: {
        stage: {
          ...
          "surface-raised": "rgb(var(--stage-surface-raised) / <alpha-value>)",
          border: "rgb(var(--stage-border) / <alpha-value>)",
          "border-strong": "rgb(var(--stage-border-strong) / <alpha-value>)",
          ...
          "on-accent": "rgb(var(--stage-on-accent) / <alpha-value>)",
          focus: "rgb(var(--stage-focus) / <alpha-value>)",
          pro: "rgb(var(--stage-pro) / <alpha-value>)",
          con: "rgb(var(--stage-con) / <alpha-value>)",
          warning: "rgb(var(--stage-warning) / <alpha-value>)",
